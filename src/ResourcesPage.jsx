        ...
        <div style={styles.sidebar}>
          ...
          <div style={styles.section}>
            ...
            <div style={styles.cheatItem}>
              <span style={{color: '#c678dd'}}>git commit</span> - зберегти
            </div>
            <div style={styles.cheatItem}>
              <span style={{color: '#c678dd'}}>git push</span> - відправити
            </div>
            <div style={styles.cheatItem}>
              <span style={{color: '#c678dd'}}>git pull</span> - отримати
            </div>
          </div>
        </div>

        {/* --- ПРАВА ПАНЕЛЬ: ЩОДЕННИК (СЛОВНИК) --- */}
        <div style={styles.mainContent}>
          ...
          <form onSubmit={handleAddNote} style={styles.form}>
            <input 
              ...
              placeholder="New word (e.g. 'deploy')" 
              style={styles.input} 
            />
            <input 
              value={definition} 
              onChange={e => setDefinition(e.target.value)} 
              placeholder="Meaning (e.g. 'to release code')" 
...
const styles = {
  container: { minHeight: '100vh', backgroundColor: '#1e1e1e', color: '#fff', fontFamily: '"JetBrains Mono", monospace', display: 'flex', justifyContent: 'center', padding: '40px' },
  layout: { display: 'flex', width: '100%', maxWidth: '1000px', backgroundColor: '#252526', borderRadius: '10px', border: '1px solid #333', overflow: 'hidden', minHeight: '600px' },
  ...
  mainContent: { flex: 1, padding: '40px', backgroundColor: '#282c34' },
